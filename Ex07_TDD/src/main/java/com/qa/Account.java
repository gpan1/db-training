...
public class Account implements Comparable<Account>{
    ...
    public String toString(){
        String[] cardType = getCardTypes();
        String cardTypeConCat = "[";
        for(String type : cardType){
            cardTypeConCat = cardTypeConCat + type + ", ";
        }
        cardTypeConCat = cardTypeConCat + "]";
        return "Card Type: " + cardTypeConCat + ", Sort Code: " + getSortCode() + ", Account Number: " + getAccountNumber() + ", Password: " + getPassword();
    }
    @Override
